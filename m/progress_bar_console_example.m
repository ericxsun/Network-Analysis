...
%PROGRESS_BAR_CONSOLE_EXAMPLE Console progress bar demo.
%   PROGRESS_BAR_CONSOLE_EXAMPLE() shows the examples for console progress 
%   bar.
%   
%   Algorithm:
%
...
%   Ref:
%
%   See also: WAITBAR, PROGRESS_BAR_CONSOLE, PROGRESS_BAR_GUI, 
